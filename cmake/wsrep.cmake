...
IF(WITH_WSREP)
  ...
  IF(NOT EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/wsrep-lib/wsrep-API/v26/wsrep_api.h")
...
")
  ...
  FILE(STRINGS "${CMAKE_CURRENT_SOURCE_DIR}/wsrep-lib/wsrep-API/v26/wsrep_api.h" WSREP_API_VERSION
  ...
  INCLUDE_DIRECTORIES(${CMAKE_CURRENT_SOURCE_DIR}/wsrep-lib/include)
  INCLUDE_DIRECTORIES(${CMAKE_CURRENT_SOURCE_DIR}/wsrep-lib/wsrep-API/v26)
