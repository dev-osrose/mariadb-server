...
FUNCTION(INSTALL_MANPAGE file)
  ...
  SET(GLOB_EXPR 
    ${CMAKE_CURRENT_SOURCE_DIR}/man/*${file}man.1*
    ${CMAKE_CURRENT_SOURCE_DIR}/man/*${file}man.8*
    ${CMAKE_CURRENT_BINARY_DIR}/man/*${file}man.1*
    ${CMAKE_CURRENT_BINARY_DIR}/man/*${file}man.8*
   )
  IF(MYSQL_DOC_DIR)
    SET(GLOB_EXPR
...
GET_FILENAME_COMPONENT(BINARY_PARENTDIR ${CMAKE_CURRENT_BINARY_DIR} PATH)
